...
public interface ISanPhamReadRepository
{
    ...
    Task<IReadOnlyList<SanPham>> LayDanhSachTheoDanhMucSlugAsync(string slug, int trang = 1, int soLuong = 12, string? tuKhoa = null, string? sapXep = null);
    Task<int> DemSoLuongTheoDanhMucSlugAsync(string slug, string? tuKhoa = null);
